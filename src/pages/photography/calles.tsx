...
import image1 from '../../../public/assets/photography/calles/1.webp'
import image2 from '../../../public/assets/photography/calles/2.webp'
import image3 from '../../../public/assets/photography/calles/3.webp'
import image4 from '../../../public/assets/photography/calles/4.webp'
import image5 from '../../../public/assets/photography/calles/5.webp'
import image6 from '../../../public/assets/photography/calles/6.webp'
import image7 from '../../../public/assets/photography/calles/7.webp'
import image8 from '../../../public/assets/photography/calles/8.webp'
...
const CallesPhotography : React.FC = () => {
        ...
        <section id="photography" className={`min-h-screen flex flex-col ${font.className}`}>
            <div className = {`header w-full leading-tight min-h-min`} style={{
                ...
                <div className="relative z-10 flex flex-col justify-around items-center p-10">
                    <CustomTitle title="Calles" color="white" classname="leading-loose"/>
                </div>
            </div>
...
export default CallesPhotography